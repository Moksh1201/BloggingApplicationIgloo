...
//     try {
//       // Replace this with your Google OAuth API call
//       const response = await axios.post("/api/auth/google");
//       const newUser = response.data;

//       // Check if user exists in your database and handle accordingly
//       const userResponse = await axios.get(`/api/users/${newUser.uid}`);
//       const userExists = userResponse.data;
...
//                 {createUser ? "Join Igloo" : "Welcome Back"}
//               </h2>
...
//             Click “Sign In” to agree to Igloo's Terms of Service and
//             acknowledge that Igloo's Privacy Policy applies to you.
//           </p>
//         </div>
//       </section>
//     </Modal>
    ...
    <Modal modal={modal} setModal={setModal}>
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center gap-[3rem]">
          ...
          <p className="md:w-[30rem] mx-auto text-center text-sm mb-[3rem]">
            Click “Sign In” to agree to Igloo's Terms of Service and acknowledge that Igloo's Privacy Policy applies to you.
          </p>
        </div>
      </section>
    </Modal>
