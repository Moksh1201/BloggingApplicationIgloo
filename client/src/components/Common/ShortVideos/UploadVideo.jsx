...
//       formData.append("userId", currentUser.id); // Sending userId
//       formData.append("username", currentUser.username); // Sending username
//       formData.append("title", videoData.title);
//       formData.append("description", videoData.description || ""); // Optional description
//       formData.append("tags", videoData.tags || ""); // Optional tags field
...
//       navigate("/"); // Redirect back to the video list
//     } catch (error) {
...
const UploadVideo = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append("title", videoData.title);
      formData.append("description", videoData.description || ""); // Optional description
      formData.append("tags", JSON.stringify(tagsArray)); // Sending tags as an array
      formData.append("video", videoData.file);
